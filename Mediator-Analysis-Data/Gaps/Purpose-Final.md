...
| tomoyo_path_truncate               |                       |                      |                       |                      |                      | :large_blue_diamond: |                    |
| tomoyo_path_unlink                 |                       |                      |                       |                      |                      | :large_blue_diamond: |                    |
| tomoyo_path_mkdir                  |                       |                      |                       |                      |                      |                      | :white_check_mark: |
| tomoyo_path_rmdir                  |                       |                      |                       |                      |                      | :large_blue_diamond: |                    |
| tomoyo_path_symlink                |                       |                      |                       |                      |                      | :large_blue_diamond: |                    |
...
| tomoyo_path_chroot                 |                       |                      |                       |                      |                      | :large_blue_diamond: |                    |
| tomoyo_sb_mount                    |                       |                      |                       |                      |                      | :large_blue_diamond: |                    |
| tomoyo_sb_umount                   |                       |                      |                       |                      |                      | :large_blue_diamond: |                    |
| tomoyo_sb_pivotroot                |                       |                      |                       |                      |                      |                      | :white_check_mark: |
| tomoyo_socket_bind                 |                       |                      | :large_blue_diamond:  | :large_blue_diamond: |                      | :large_blue_diamond: |                    |
| tomoyo_socket_connect              |                       |                      | :large_blue_diamond:  | :large_blue_diamond: |                      | :large_blue_diamond: |                    |
| tomoyo_socket_listen               |                       |                      | :large_blue_diamond:  | :large_blue_diamond: |                      | :large_blue_diamond: |                    |
| tomoyo_socket_sendmsg              |                       |                      | :large_blue_diamond:  | :large_blue_diamond: |                      | :large_blue_diamond: |                    |
| ------                             |                       |                      |                       |                      |                      |                      |                    |
| **_APPARMOR_**                     |                       |                      |                       |                      |                      |                      |                    |
...
| apparmor_mmap_file                 | :large_blue_diamond:  |                      |                       |                      |                      |                      |                    |
...
| selinux_mmap_addr                  |     :red_circle:      |                      |                       |                      |                      | :large_blue_diamond: |                    |
