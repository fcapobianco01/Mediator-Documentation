...
| selinux_inode_setxattr             |    -/1    |          |    -/3    |          |   2/8    |   3/7    |            |   1/5    |          |   6/16    |
| selinux_inode_getxattr             |           |          |    -/1    |          |          |          |            |   2/1    |          |    1/-    |
| selinux_inode_listxattr            |           |          |    -/1    |          |          |          |            |   1/1    |          |    1/-    |
| selinux_inode_removexattr          |           |          |    -/2    |          |   2/3    |   -/5    |            |   1/3    |          |    3/8    |
| selinux_inode_getsecurity          |    2/-    |   -/2    |           |          |   -/1    |   -/2    |    -/2     |          |          |    4/4    |
...
| selinux_file_mprotect              |    2/-    |   -/2    |    -/1    |   -/1    |   1/8    |   1/8    |    -/5     |   1/8    |          |   6/18    |
...
| selinux_setprocattr                |    -/1    |          |    1/-    |          |   2/3    |   2/3    |            |   2/-    |          |    5/7    |
| selinux_inode_getsecctx            |    2/-    |   -/2    |           |          |   -/1    |   -/2    |    -/2     |          |          |    4/4    |
...
| selinux_socket_connect             |           |          |    1/2    |   1/2    |   1/1    |   -/2    |    1/2     |   3/6    |          |    2/5    |
