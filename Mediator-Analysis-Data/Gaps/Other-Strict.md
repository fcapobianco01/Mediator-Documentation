...
| apparmor_path_chmod                |                              |         :red_circle:         |         :red_circle:         |      :large_blue_diamond:       |                    |
| apparmor_path_chown                |                              |         :red_circle:         |         :red_circle:         |                                 |                    |
| apparmor_path_truncate             |                              |         :red_circle:         |         :red_circle:         |                                 |                    |
| apparmor_inode_getattr             |                              |         :red_circle:         |         :red_circle:         |      :large_blue_diamond:       |                    |
| apparmor_file_open                 |     :large_blue_diamond:     |     :large_blue_diamond:     |                              |          :red_circle:           |                    |
| apparmor_file_permission           |         :red_circle:         |         :red_circle:         |         :red_circle:         |      :large_blue_diamond:       |                    |
