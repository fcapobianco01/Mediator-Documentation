...
| tomoyo_path_mkdir                  |    -/1    |   -/2    |           |   -/2    |          |   -/1    |    1/4     |   1/3    |          |    1/3    |
...
| tomoyo_path_chown                  |    -/2    |   -/1    |    -/3    |   -/3    |   -/1    |   -/2    |    -/4     |   2/10   |          |    1/3    |
| tomoyo_path_chroot                 |    -/2    |   -/1    |           |   -/1    |          |   -/2    |    -/2     |   -/3    |          |    1/3    |
| tomoyo_sb_mount                    |           |          |           |   -/4    |          |   -/2    |    1/6     |   1/12   |          |           |
