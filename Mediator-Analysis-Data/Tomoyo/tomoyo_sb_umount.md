...
|-------------------------------|--------------------|-----------------------------------|-----------------------------|
| 10 [TOMOYO_TYPE_UMOUNT]       |                    | security/tomoyo/tomoyo.c:428      | operation, static, mediator | 
| mnt                           |                    | security/tomoyo/tomoyo.c:425      | object, dynamic, input      |
| flags                         |                    | security/tomoyo/tomoyo.c:425      | operation, dynamic, input   |
